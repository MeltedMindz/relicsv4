...
import { type Rc6LaunchParamsField } from "./generated/rc6LaunchParams.js";
/**
...
export declare const ArtMode: {
    readonly SOLIDITY_SVG: 0;
    readonly JAVASCRIPT: 1;
};
export type ArtModeValue = (typeof ArtMode)[keyof typeof ArtMode];
export declare const StartingPreset: {
    readonly LOW: 0;
    readonly MID: 1;
    readonly HIGH: 2;
};
 ...
 */
export declare const BurnPolicy: {
    readonly NONE: 0;
    readonly HOLDER_BURN: 1;
    readonly HOLDER_AND_ALLOWANCE_BURN: 2;
};
 ...
 */
export declare const AntiSnipeMode: {
    readonly UNSPECIFIED: 0;
    readonly NONE: 1;
    readonly PROTECTED_98_MINUTES: 2;
};
 ...
 */
export declare function launchParamsAsTuple(p: LaunchParams): Record<Rc6LaunchParamsField, unknown>;
/**
 ...
 */
export declare function metadataDigestForUri(uri: string): Hex;
