...
} as const satisfies Record<Rc6LaunchParamsField, string>;

/** The fully expanded canonical signature the factory actually exposes. */
export const RC6_LAUNCH_SIGNATURE = "launch((string,string,uint256,uint256,uint8,bytes32,bytes32,uint8,uint256,bytes32,bytes,bytes,address,(address,uint16)[],uint8,uint8,bytes32,uint256,uint256))" as const;
