...
// Mirrors src/Constants.sol at v4-art-launchpad G-1.1 hardening wave (baseline 7f909da +
// integrated G-1.1 contract changes: ProjectDeploymentHelper, FeeModel/FeeModelReader, organic
// TWAP conversion gate, retuned script-byte ceilings).
import type { Address } from "viem";
import {
  BPS_DENOMINATOR as SCHEMA_BPS_DENOMINATOR,
  CREATOR_SHARE_BPS as SCHEMA_CREATOR_SHARE_BPS,
  PLATFORM_SHARE_BPS as SCHEMA_PLATFORM_SHARE_BPS,
  RELICS_BUYBACK_BPS_OF_PLATFORM_SHARE as SCHEMA_RELICS_BUYBACK_BPS,
  PLATFORM_RETAINED_BPS_OF_PLATFORM_SHARE as SCHEMA_PLATFORM_RETAINED_BPS,
  NOMINAL_ALLOCATION_BPS as SCHEMA_NOMINAL_ALLOCATION_BPS,
...
export const FORK_BLOCK = 25_690_000n;
 ...
 */
export const FEE_DISCLOSURE_TEXT =
  "The project pool has a fixed 1% LP fee. LP fees collected by the permanent genesis position are split 75% to the creator and 25% to the platform. Any Uniswap protocol fee is separate and displayed from current pool state.";
...
export const DEFAULT_LOCKER_CONVERSION_POLICY = {
  minConversionBatch: 1_000_000_000n, // 1e9
  maxConversionBatch: 1_000_000_000_000_000_000_000_000n, // 1e24
...
export const EIP7825_TX_GAS_CAP = 16_777_216n;
export const ENGINEERING_GAS_CEILING = 14_000_000n;

export const WHOLE_UNIT = 1_000_000_000_000_000_000n; // 1e18
 ...
 */
export const REFERENCE_GAS_ANCHORS: { scriptBytes: number; oneCallGas: number }[] = [
