...
const record = {
  $comment: [
    ...
    "",
    "WHAT THIS RECORD DOES NOT YET CONTAIN, stated here rather than left for a reader to notice:",
    "NO RUN HAS BEEN ACCEPTED. Across these briefs every first legal configuration was refused on",
    "brief fidelity, and three runs spent all four judgements without reaching SHIP. The acceptance",
    "path — the objective battery, the receipt, and the invalidation that voids it — is therefore",
    "proved by `packages/art-review/test/loop.test.mjs` and by the mutation section of",
    "`scripts/check-art-review.mjs`, not by a live run in this record. That is a real limit on what",
    "these runs evidence, and inventing an acceptance to close it would be the exact substitution",
