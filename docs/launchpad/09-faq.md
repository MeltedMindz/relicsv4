...
**Can I launch today?**
No. RC6 is not deployed on any chain, and a deployed factory starts closed to ordinary creators
regardless. You can build, validate and export a real `.relics` file today — that work is not
wasted, because a bundle describes a project rather than a protocol release. Do not broadcast a
launch transaction until the factory on your chain reports that it accepts public launches.
