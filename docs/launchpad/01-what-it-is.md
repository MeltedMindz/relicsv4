...
and for why no address appears in this documentation yet.
...
generalizes. It is live on Ethereum mainnet; the launchpad is a separate system and public creator
launches are not open on any chain.
